...
const defaultState = {
  ...
  speedTestHistory: [],
  switchPorts: [
    { id: 'port1', label: 'Port 1', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port2', label: 'Port 2', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port3', label: 'Port 3', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port4', label: 'Port 4', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port5', label: 'Port 5', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port6', label: 'Port 6', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port7', label: 'Port 7', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'port8', label: 'Port 8', status: 'Nicht belegt', color: '#7a7a7a' },
  ],
  routerPorts: [
