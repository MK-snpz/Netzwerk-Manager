...
const defaultState = {
  ...
  speedTestHistory: [],
  switchPorts: [
    { id: 'port1', label: 'Port 1', status: 'Verbindung zum WLAN Router', color: '#000000' },
    { id: 'port2', label: 'Port 2', status: 'Schlafzimmer Luke', color: '#000000' },
    { id: 'port3', label: 'Port 3', status: 'Schlafzimmer Ella', color: '#000000' },
    { id: 'port4', label: 'Port 4', status: 'Schlafzimmer Eltern', color: '#000000' },
    { id: 'port5', label: 'Port 5', status: 'Büro', color: '#000000' },
    { id: 'port6', label: 'Port 6', status: 'Esszimmer', color: '#000000' },
    { id: 'port7', label: 'Port 7', status: 'Wohnzimmer 2', color: '#000000' },
    { id: 'port8', label: 'Port 8', status: 'Wohnzimmer 1', color: '#000000' },
  ],
  routerPorts: [
    { id: 'dsl', label: 'DSL', status: 'Nicht belegt', color: '#7a7a7a' },
    { id: 'lan1', label: 'Link/LAN1', status: 'Nicht belegt', color: '#0050c8' },
    { id: 'lan2', label: 'LAN2', status: 'Nicht belegt', color: '#d1ac00' },
    { id: 'lan3', label: 'LAN3', status: 'Nicht belegt', color: '#d1ac00' },
    { id: 'lan4', label: 'LAN4', status: 'Nicht belegt', color: '#d1ac00' },
    { id: 'telefon', label: 'Telefon', status: 'Nicht belegt', color: '#d97800' },
  ],
  versions: [],
};
